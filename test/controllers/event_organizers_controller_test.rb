...
class EventOrganizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_organizer" do
    assert_difference("EventOrganizer.count") do
      post event_organizers_url, params: { event_organizer: { description: @event_organizer.description, email: @event_organizer.email, firstName: @event_organizer.firstName, lastName: @event_organizer.lastName } }
    end
  ...
  test "should update event_organizer" do
    patch event_organizer_url(@event_organizer), params: { event_organizer: { description: @event_organizer.description, email: @event_organizer.email, firstName: @event_organizer.firstName, lastName: @event_organizer.lastName } }
